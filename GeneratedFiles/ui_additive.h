...
"}"));
        ...
        actionFullscreen = new QAction(additiveClass);
        ...
        pushButton->setGeometry(QRect(180, 90, 81, 21));
        ...
        sizePolicy.setHeightForWidth(centralWidget2->sizePolicy().hasHeightForWidth());
        centralWidget2->setSizePolicy(sizePolicy);
        centralWidget2->setMouseTracking(false);
        gridLayout = new QGridLayout(centralWidget2);
    ...
    void retranslateUi(QMainWindow *additiveClass)
    {
        ...
        actionFullscreen->setText(QApplication::translate("additiveClass", "FullScreen", 0, QApplication::UnicodeUTF8));
        actionFullscreen->setShortcut(QApplication::translate("additiveClass", "Alt+Return", 0, QApplication::UnicodeUTF8));
        ...
        checkBox_2->setText(QApplication::translate("additiveClass", "Muscles", 0, QApplication::UnicodeUTF8));
