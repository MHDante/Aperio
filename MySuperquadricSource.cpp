...
Module:    MySuperquadricSource.cxx
...
void MySuperquadricSource::SetPhiResolution(int i)
{
	if (i < 4)
	{
		i = 4;
...
void MySuperquadricSource::SetThetaResolution(int i)
{
	if (i < 8)
	{
		i = 8;
...
void MySuperquadricSource::SetThetaRoundness(double e)
{
...
void MySuperquadricSource::SetPhiRoundness(double e)
{
	if (e < VTK_MIN_SUPERQUADRIC_ROUNDNESS)
	{
		e = VTK_MIN_SUPERQUADRIC_ROUNDNESS;
...
int MySuperquadricSource::RequestData(
...
void MySuperquadricSource::PrintSelf(ostream& os, vtkIndent indent)
{
	...
	double taper)      // output normals
{
	...
	// tapering
	xyz[0] = (taper * xyz[2] / dims[2] + 1) * xyz[0];
	xyz[1] = (taper * xyz[2] / dims[2] + 1) * xyz[1];
