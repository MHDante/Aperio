...
=========================================================================*/
// .NAME vtkMyDepthPeelingPass - Implement an Order Independent Transparency
// render pass.
// .SECTION Description
...
#ifndef __vtkMyDepthPeelingPass_h
#define __vtkMyDepthPeelingPass_h
...
class vtkMyDepthPeelingPass : public vtkRenderPass
{
public:
	static vtkMyDepthPeelingPass *New();
	vtkTypeMacro(vtkMyDepthPeelingPass, vtkRenderPass);
...
protected:
	...
	vtkMyDepthPeelingPass();

	// Description:
	// Destructor.
	virtual ~vtkMyDepthPeelingPass();
...
private:
	vtkMyDepthPeelingPass(const vtkMyDepthPeelingPass&);  // Not implemented.
	void operator=(const vtkMyDepthPeelingPass&);  // Not implemented.
};
