...
vtkStandardNewMacro(vtkMyDepthPeelingPass);
vtkCxxSetObjectMacro(vtkMyDepthPeelingPass, TranslucentPass, vtkRenderPass);
...
const char *vtkDepthPeeling_fs = fs.c_str();

// ----------------------------------------------------------------------------
vtkMyDepthPeelingPass::vtkMyDepthPeelingPass()
{
...
void vtkMyDepthPeelingPass::ReleaseGraphicsResources(vtkWindow *w)
{
...
// ----------------------------------------------------------------------------
void vtkMyDepthPeelingPass::PrintSelf(ostream& os, vtkIndent indent)
{
...
// \pre s_exists: s!=0
void vtkMyDepthPeelingPass::Render(const vtkRenderState *s)
{
...
// ----------------------------------------------------------------------------
void vtkMyDepthPeelingPass::CheckSupport(vtkOpenGLRenderWindow *w)
{
	assert("pre: w_exists" && w != 0);
	vtkOpenGLClearErrorMacro();
...
void vtkMyDepthPeelingPass::CheckCompilation(
...
int vtkMyDepthPeelingPass::RenderPeel(const vtkRenderState *s,
	int layer)
{
	assert("pre: s_exists" && s != 0);
