...
=========================================================================*/
// .NAME vtkMyFillHolesFilter - identify and fill holes in meshes
// .SECTION Description
// vtkMyFillHolesFilter is a filter that identifies and fills holes in
...
#ifndef __vtkMyFillHolesFilter_h
#define __vtkMyFillHolesFilter_h
...
class vtkMyFillHolesFilter : public vtkPolyDataAlgorithm
{
public:
	// Description:
	// Standard methods for instantiation, type information and printing.
	static vtkMyFillHolesFilter *New();
	vtkTypeMacro(vtkMyFillHolesFilter, vtkPolyDataAlgorithm);
...
private:
	vtkMyFillHolesFilter(const vtkMyFillHolesFilter&);  // Not implemented.
	void operator=(const vtkMyFillHolesFilter&);  // Not implemented.
};
