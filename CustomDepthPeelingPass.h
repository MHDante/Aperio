...
Module:    CustomDepthPeelingPass.h
...
=========================================================================*/
// .NAME CustomDepthPeelingPass - Implement an Order Independent Transparency
// render pass.
// .SECTION Description
...
#ifndef __CustomDepthPeelingPass_h
#define __CustomDepthPeelingPass_h
...
class CustomDepthPeelingPass : public vtkRenderPass
{
public:
	static CustomDepthPeelingPass *New();
	vtkTypeMacro(CustomDepthPeelingPass, vtkRenderPass);
...
protected:
	...
	CustomDepthPeelingPass();

	// Description:
	// Destructor.
	virtual ~CustomDepthPeelingPass();
...
private:
	CustomDepthPeelingPass(const CustomDepthPeelingPass&);  // Not implemented.
	void operator=(const CustomDepthPeelingPass&);  // Not implemented.
};
