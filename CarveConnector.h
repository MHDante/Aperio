...
public:
	...
	static unique_ptr<carve::mesh::MeshSet<3> > perform(unique_ptr<carve::mesh::MeshSet<3> > &a, unique_ptr<carve::mesh::MeshSet<3> > &b, carve::csg::CSG::OP op, bool triangulate);
